...
const occasions = [
  {
    name: "Diwali",
    description: "Curated hampers for homes and offices, beautifully packed.",
    image: "/images/assorted-box.jpg",
  },
  {
    name: "Raksha Bandhan",
    description: "Rakhi specials with laddoos, barfis, and keepsake boxes.",
    image: "/images/motichoor-laddoo.jpg",
  },
  {
    name: "Weddings",
    description: "Bespoke mithai boxes for mehendi, sangeet, and reception.",
    image: "/images/kaju-katli.jpg",
  },
  {
    name: "Corporate gifting",
    description: "Branded boxes with pan-India shipping and bulk pricing.",
    ...
    <div className="flex flex-1 flex-col gap-16">
      ...
      >
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <p className="text-xs text-text-muted">{t("heroNote")}</p>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-md text-xs text-text-muted">
            From intimate poojas to thousand‑box corporate hampers, we help you
            plan the perfect mithai for each moment.
          </p>
        </div>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm text-text-light-muted">
            We obsess over ingredients, texture, and packaging so your mithai
            tastes as good as it looks — and arrives fresh, every single time.
          </p>
          ...
          <dl className="grid gap-4 text-sm sm:grid-cols-2">
            <div>
              ...
              <dd className="text-text-light-muted">
                Sweets are prepared in limited batches through the week for peak
                flavour and texture.
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-text-light-muted">
                Modern, FSSAI‑certified kitchen with strict hygiene standards
      ...
      >
        <div className="space-y-3">
          ...
          <p className="text-sm text-text-info">{t("corporateLead")}</p>
