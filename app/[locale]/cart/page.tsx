    ...
    <div className="mx-auto mt-4 flex w-full max-w-4xl flex-1 flex-col">
      ...
      {items.length === 0 ? (
        <p className="mt-6 text-sm text-text-muted">
          ...
          <Link href="/sweets" className="font-semibold text-primary">
            sweets catalog
          </Link>{" "}
        ...
        <>
          ...
          <div className="mt-6 flex flex-col gap-3 border-t border-border-card pt-4 text-xs text-text-muted">
            ...
            <p>
              Final pricing, shipping, and taxes will be shown at checkout. For
              bulk or corporate orders, we may contact you to confirm details.
            </p>
