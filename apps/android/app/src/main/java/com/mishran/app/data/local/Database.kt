// apps/android/app/src/main/java/com/mishran/app/data/local/Database.kt — Tasks 9.1 / 10.1 / 11.1.
//
// Room database for the offline-first catalog + local cart + order cache.
// v2 added the cart_items table; v3 adds the orders cache; destructive
// fallback is still acceptable pre-launch. exportSchema is off for now —
// flip on (and configure room.schemaLocation) once the schema stabilizes
// so migration tests can golden-file it.
