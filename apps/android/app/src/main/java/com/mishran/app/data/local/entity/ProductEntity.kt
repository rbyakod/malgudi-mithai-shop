// apps/android/app/src/main/java/com/mishran/app/data/local/entity/ProductEntity.kt — Task 9.1.
//
// Offline cache row for a catalog product. Mirrors the generated `Product`
// contract (id/slug/name/family/displayPrice/freshnessStatus/dietaryTags/
// allergens/ingredients/shelfLife/storage/images/story/karigar/updatedAt) with
// two adaptations Room requires:
